...
class IpAddress {
     ...
     * @return {object} (ipv4, ipv6) - An IPv4 and IPv6 address.
     */
    getFirstIpAddress(cidrStr, callback) {
        ...
        mappedAddress.ipv4 = firstIpAddress;

        // Here we call our helper function to calculate IPv4-mapped IPv6 address from a passed IPv4 address
        if (mappedAddress.ipv4 !== null) {
            mappedAddress.ipv6 = getIpv4MappedIpv6Address(firstIpAddress);
        }
